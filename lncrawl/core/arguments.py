...
_builder = Args(
    group=[
        ...
        Args(
            ...
            metavar="REGEX",
            help="Filter out the sources to search for novels.",
        ),
        Args(
            "--login",
            nargs=2,
        ...
        Args(
            ...
            type=str,
            metavar="FILE",
            help="Proxies as SCHEME://HOST:PORT@USER:PASSWORD format in each line. All except HOST are optional",
        ),
        Args(
            "--auto-proxy",
            action="store_true",
        ...
        Args(
            ...
            default=argparse.SUPPRESS,
            metavar="NAME/URL",
            help="Resume download of a novel containing in " + C.DEFAULT_OUTPUT_PATH,
        ),
        Args(
            "extra",
            type=parse_qs,
